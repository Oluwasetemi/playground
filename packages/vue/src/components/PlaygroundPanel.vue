<template>
  <div class="playground-panel">
    <div class="playground-panel-header">
      <div class="playground-panel-tabs">
        <button
          v-for="tab in tabs"
          :key="tab"
          :class="['playground-panel-tab', activeTab === tab ? 'active' : '']"
          @click="activeTab = tab"
        >
          {{ tab.charAt(0).toUpperCase() + tab.slice(1) }}
          <span
            v-if="tab === 'console' && consoleMessages.length > 0"
            :class="['console-badge', errorCount > 0 ? 'error' : warnCount > 0 ? 'warn' : 'log']"
    ...
    <div class="playground-panel-content">
      <div :class="['playground-panel-result', activeTab === 'result' ? 'active' : '']">
      ...
      <div :class="['playground-panel-console', activeTab === 'console' ? 'active' : '']">
        <div class="console-toolbar">
          ...
          <div class="console-filters">
            <button
              ...
              :key="f"
              :class="['console-filter-btn', filter === f ? 'active' : '', f !== 'all' ? f : '']"
              @click="filter = f"
            >
      ...
      <div :class="['playground-panel-terminal', activeTab === 'terminal' ? 'active' : '']">
